                        ...
                        <nav
                            ...
                            <section style="width: 100%;">
                                ...
                                <ul
                                    ...
                                    <li class="list-item">
                                        <a href="#"
                                            style="text-decoration: none;  width: 100%; height: 100%; display: block;"
                                            onclick="window.location = './pages/ManageProduct.html';">Manage
                                            Product</a>
                                    </li>
                                    <li class="list-item">
                                        <a href="#"
                                            style="text-decoration: none;  width: 100%; height: 100%; display: block;"
                                            onclick="window.location = './pages/ViewOrder.html';">View Customer's
                                            Order</a>
                                    </li>
                                </ul>
                            </section>
