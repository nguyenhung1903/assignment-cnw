...
const validateLogin = () => {
    ...
    if (password.length >= 3) {
        if (document.querySelector('.pass-length').classList.contains("test-failed")) {
        ...
        if (password.length != 0) {
            if (document.querySelector('.pass-length').classList.contains("test-ok")) {
    ...
    if (username.length >= 3) {
        if (document.querySelector('.user-length').classList.contains("test-failed")) {
        ...
        if (username.length != 0) {
            if (document.querySelector('.user-length').classList.contains("test-ok")) {
    ...
    if (passwordRegex.test(password)) {
        if (document.querySelector('.pass-letter').classList.contains("test-failed")) {
            document.querySelector('.pass-letter').classList.remove("test-failed")
        }
        document.querySelector('.pass-letter').classList.add("test-ok")
    } else {
        if (password.length != 0) {
            if (document.querySelector('.pass-letter').classList.contains("test-ok")) {
    ...
    if (usernameRegex.test(username)) {
        if (document.querySelector('.user-letter').classList.contains("test-failed")) {
            document.querySelector('.user-letter').classList.remove("test-failed")
        }
        document.querySelector('.user-letter').classList.add("test-ok")
    } else {
        if (username.length != 0) {
            if (document.querySelector('.user-letter').classList.contains("test-ok")) {
